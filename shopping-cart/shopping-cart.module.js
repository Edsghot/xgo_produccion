...
const shopingCart_entity_1 = require("./entity/shopingCart.entity");
let ShoppingCartModule = exports.ShoppingCartModule = class ShoppingCartModule {
};
exports.ShoppingCartModule = ShoppingCartModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([shopingCart_entity_1.ShoppingCart])],
